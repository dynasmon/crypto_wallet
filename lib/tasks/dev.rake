    ...
    show_spinner("Cadastrando moedas...") do
      coins = [
                ...
                },
                {
                  description: "Nathan",
                  acronym: "NATH",
                  url_image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQe77aPvXCsZnHYrSzE9aOL7ZoZP8O17ZwwEA&usqp=CAU",
                  mining_type: MiningType.find_by(acronym: 'PoN')
                }
              ]
  ...
  task add_mining_types: :environment do
    show_spinner("Cadastrando tipos de mineração...") do
      mining_types = [
        ...
        {description: "Proof of Naoseioq", acronym: "PoN"}
      ]
